...
## Project Overview
This project aims to analyze a sales dataset to derive insights into product performance, revenue trends, and customer behavior. The dataset includes information such as order ID, product details, quantity ordered, prices, order date, purchase addresses, sales amounts, city, and month.
